<template>
    ...
    <div class="fixed bottom-0 left-0 bg-white p-5 pb-4 text-left align-top w-full h-16">
        ...
        <div class="float-left w-7 h-7 leading-3">
            ...
            <i class="fa text-gray-500 text-xl" :class="{'fa-play': !playing, 'fa-pause': playing}">Play</i>
            </button>
        </div>
        <!-- Current Position -->
        ...
        <div class="float-left w-7 h-7 leading-3 ml-7 mt-2 player-scrub">
            <div v-if="currentSong.modified_name" class="absolute left-0 right-0 text-lg text-center mx-auto player-song-info">

    ...
    <main>
        ...
        <section id="comments" class="container mx-auto mt-6">
            <div class="bg-white rounded border border-gray-200 relative flex flex-col">
                ...
                <div class="p-6">
                    <div v-if="comment_show_alert" class="text-white text-center font-bold p-4 mb-4" :class="comment_alert_variant">
                        {{ comment_alert_messsage }}
                    </div>
                    <vee-form v-if="userLoggedIn" :validation-schema="schema" @submit="addComment">
                        <vee-field as="textarea" name="comment" class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition duration-500 focus:outline-none focus:border-black rounded mb-4"
...
export default {
    ...
    data() {
        return {
            ...
            comment_alert_messsage: 'Please wait. Your comment is being submitted.',
            sort: '1',
            comments: [],
        }
    },
    ...
    methods: {
        ...
        async addComment(values, { resetForm }) {
            ...
            this.comment_alert_messsage = 'Please wait. Your comment is being submitted.'
            ...
            this.comment_alert_messsage = 'Comment added!';

            resetForm();
        },
        async getComments() {
            const snaps = await commentsCollection.where('sid', '==', this.$route.params.id).get();
